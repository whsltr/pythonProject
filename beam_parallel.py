...
path = '/home/kun/Documents/mathematics/gaichao/55_'
f = open(path + '1_1.txt', 'w')
...
theta = 55
vr0 = 0
vr1 = 8.6 * sin((theta / 360) * (2 * pi))
vd1 = 8.6 * cos((theta / 360) * (2 * pi))
print(vd1)
vd0 = -vd1 * (n1 / n0)
vr2 = 0
vd2 = 0
...
fig, ax = plt.subplots()
ax.axis([xmin, xmax, -1, 30])
# norm = colors.Normalize(vmin=-0.04, vmax=0.0252)
