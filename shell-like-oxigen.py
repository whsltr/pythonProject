...
path = '/home/kun/Documents/mathematics/shell-like/hydrogen/small_pui_temp/'
alpha_i = 83
f = open(path + str(alpha_i) + '_4.txt', 'w')
...
while alpha <= alpha_max:
    ...
    while k >= k_min:
        ...
        while delta < err < 1000:
            ...
            for omega in om:
                ...
                for i in range(16):
                    ...
                    sb12 = sum(
                        1j * 4 * n / (As1 * as1) * (
                                (vtper1[i] ** 2) / (vtpar1[i] ** 2) * b0[i, n + nmax] * eta1(omega, n)
                                + b1[i, n + nmax] * (
                                        n * m1 / k_v)) * Z(
                            eta1(omega, n)) for n in range(nmin, nmax + 1))
        ...
        print("{:.3f}".format(k), '  ', omega2, "  ", pl.real, '   c=', c)
