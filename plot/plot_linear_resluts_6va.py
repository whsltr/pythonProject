...
pth = '/home/kun/Documents/mathematics/beam/0.01/' + '6va_01'
f = open(pth + '.txt')
omegai1 = []
omegar1 = []
polarization1 = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/' + '6va_00'
f = open(pth + '.txt')
omegai0 = []
omegar0 = []
polarization0 = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/' + '6va_31'
f = open(pth + '.txt')
omegai1 = []
omegar1 = []
polarization1 = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/' + '6va_30'
f = open(pth + '.txt')
omegai0 = []
omegar0 = []
polarization0 = []
