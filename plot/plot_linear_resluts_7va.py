...
pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_01'
f = open(pth + '.txt')
omegai1 = []
omegar1 = []
polarization1 = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_00'
f = open(pth + '.txt')
omegai0 = []
omegar0 = []
polarization0 = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_41'
f = open(pth + '.txt')
omegai1 = []
omegar1 = []
polarization1 = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_40'
f = open(pth + '.txt')
omegai0 = []
omegar0 = []
polarization0 = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_70_1'
f = open(pth + '.txt')
omegai1_t = []
omegar1_t = []
polarization1_t = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_70_0'
f = open(pth + '.txt')
omegai0_t = []
omegar0_t = []
polarization0_t = []
...
omegai1[700:, 55:95] = omegai1_t
omegar1[700:, 55:95] = omegar1_t
polarization1[700:, 55:95] = polarization1_t

pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_014_1'
f = open(pth + '.txt')
omegai1_t = []
omegar1_t = []
polarization1_t = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_014_0'
f = open(pth + '.txt')
omegai0_t = []
omegar0_t = []
polarization0_t = []
...
omegai1[14:30, :95] = omegai1_t
omegar1[14:30, :95] = omegar1_t
polarization1[14:30, :95] = polarization1_t

pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_17_2511'
f = open(pth + '.txt')
omegai1_t = []
omegar1_t = []
polarization1_t = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_17_2500'
f = open(pth + '.txt')
omegai0_t = []
omegar0_t = []
polarization0_t = []
...
omegai1[170:, 95:] = omegai1_t
omegar1[170:, 95:] = omegar1_t
polarization1[170:, 95:] = polarization1_t

pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_18_2511'
f = open(pth + '.txt')
omegai1_t = []
omegar1_t = []
polarization1_t = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_18_2500'
f = open(pth + '.txt')
omegai0_t = []
omegar0_t = []
polarization0_t = []
...
# omegai1[180:500, 95:140] = omegai1_t
# omegar1[180:500, 95:140] = omegar1_t
# polarization1[180:500, 95:140] = polarization1_t

pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_02_2211'
f = open(pth + '.txt')
omegai1_t = []
omegar1_t = []
polarization1_t = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/ptp_8/' + '10va_02_2200'
f = open(pth + '.txt')
omegai0_t = []
omegar0_t = []
polarization0_t = []
...
omegai1[20:189, 95:120] = omegai1_t
omegar1[20:189, 95:120] = omegar1_t
polarization1[20:189, 95:120] = polarization1_t
...
font1 = {'family': 'Times New Roman',
         'weight': 'normal',
         'size': 14}
x = np.linspace(0.01, 0.4, nx+nx1)
y = np.linspace(0.01, 8, 800)
X, Y = np.meshgrid(x, y)
eta = (omegar1 - X*10 + 1) / (X * np.sqrt(0.01))
eta2 = (omegar1 - X*10 + 2) / (X * np.sqrt(0.01))
fig = plt.figure()
...
contour2 = plt.contour(X, Y, eta2, [1], alpha=1, Nchunk=0, linestyles='-', colors='w')
...
plt.clabel(contour2, inline=1, manual=True)

plt.savefig(pth + '_.png')
plt.show()
