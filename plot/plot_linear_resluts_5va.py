...
pth = '/home/kun/Documents/mathematics/beam/0.01/' + '5va_01'
f = open(pth + '.txt')
omegai1 = []
omegar1 = []
polarization1 = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/' + '5va_00'
f = open(pth + '.txt')
omegai0 = []
omegar0 = []
polarization0 = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/' + '5va_31'
f = open(pth + '.txt')
omegai1 = []
omegar1 = []
polarization1 = []
...
pth = '/home/kun/Documents/mathematics/beam/0.01/' + '5va_30'
f = open(pth + '.txt')
omegai0 = []
omegar0 = []
polarization0 = []
...
font1 = {'family': 'Times New Roman',
         'weight': 'normal',
         'size': 14}
x = np.linspace(0.02, 0.5, nx+nx1)
y = np.linspace(0.01, 7, 700)
X, Y = np.meshgrid(x, y)
eta = (omegar1 - X*10 + 1)
fig = plt.figure()
