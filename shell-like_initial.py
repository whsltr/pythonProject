...
path = '/home/kun/Documents/mathematics/shell/'
alpha_i = 89
...
as_total = sum(a_s(theta, vtpar1, vtper1) for theta in range(-10, 191, 10))
while alpha <= alpha_max:
    ...
    while k >= k_min:
        ...
        a0 = np.array(a0).reshape(21, nmax - nmin + 1)
        a1 = np.array(a1).reshape(21, nmax - nmin + 1)
        b0 = np.array(b0).reshape(21, nmax - nmin + 1)
        b1 = np.array(b1).reshape(21, nmax - nmin + 1)
        c0 = np.array(c0).reshape(21, nmax - nmin + 1)
        c1 = np.array(c1).reshape(21, nmax - nmin + 1)
        ...
        print(k, '  ', omega2, "  ", pl.real, '   c=', c, "   eta0=", eta0(omega2, -1))
