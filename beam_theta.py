...
path = '/home/kun/Documents/mathematics/beam/0.01/'
...
while theta <= theta_max:
    ...
    it = 0
    while k1 <= xmax:
        k2 = k1 * np.tan((theta / 360) * 2 * np.pi)
        err = 1
        c = 1
        ...
        print(k1, '  k2=', k2, '   ', omega2, "  ", pl.real, '   c=', c, "   eta1=",
              (omega2.real - k1 * vd1 + 1 * m1) / (sqrt(2) * k1 * vtpar1))
        print(k1, '  ', omega2.real, '  ', omega2.imag, '  ', pl.real, '  ',
