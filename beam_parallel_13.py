...
for i in range(1):
    print(i)
    path = '/home/kun/Documents/mathematics/beam/0.01/10va/theta_' + str(i) + '/'
    f = open(path + '1_3.txt', 'w')
    theta = i
    ...
    fig, ax = plt.subplots()
    ax.axis([xmin, xmax, -2, (xmax*vd1).real])
    ...
    ax.set_title(r'$\alpha =' + str(i) + '\degree$', fontsize=18)
